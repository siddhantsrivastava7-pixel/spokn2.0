...
async detectHardware() : Promise<HardwareInfo> {
    return await TAURI_INVOKE("detect_hardware");
},
...
async changeTranscriptionLanguagesSetting(languages: string[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_transcription_languages_setting", { languages }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setUserName(firstName: string, lastName: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_user_name", { firstName, lastName }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setKnownNames(names: string[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_known_names", { names }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async resetLearnedVocabulary() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("reset_learned_vocabulary") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async startKnockCalibration() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("start_knock_calibration") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async cancelKnockCalibration() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("cancel_knock_calibration") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setConversationModeEnabled(enabled: boolean) : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_conversation_mode_enabled", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setChatModeEnabled(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_chat_mode_enabled", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async setChatModeCountdownSecs(secs: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("set_chat_mode_countdown_secs", { secs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async conversationResume() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("conversation_resume") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async conversationForceSend() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("conversation_force_send") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async conversationCancelSend() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("conversation_cancel_send") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async conversationInsertPending() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("conversation_insert_pending") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async conversationDiscardPending() : Promise<Result<string, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("conversation_discard_pending") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async deleteVocabCandidate(word: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("delete_vocab_candidate", { word }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async promoteVocabCandidate(word: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("promote_vocab_candidate", { word }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async clearVocabCandidates() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("clear_vocab_candidates") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async addSnippet(trigger: string, expansion: string) : Promise<Result<string, string>> {
    try {
...
export type AppSettings = { bindings: Partial<{ [key in string]: ShortcutBinding }>; push_to_talk: boolean; audio_feedback: boolean; audio_feedback_volume?: number; sound_theme?: SoundTheme; start_hidden?: boolean; autostart_enabled?: boolean; update_checks_enabled?: boolean; selected_model?: string; always_on_microphone?: boolean; selected_microphone?: string | null; clamshell_microphone?: string | null; selected_output_device?: string | null; translate_to_english?: boolean; selected_language?: string; overlay_position?: OverlayPosition; debug_mode?: boolean; log_level?: LogLevel; custom_words?: string[]; model_unload_timeout?: ModelUnloadTimeout; word_correction_threshold?: number; history_limit?: number; recording_retention_period?: RecordingRetentionPeriod; paste_method?: PasteMethod; clipboard_handling?: ClipboardHandling; auto_submit?: boolean; auto_submit_key?: AutoSubmitKey; post_process_enabled?: boolean; post_process_provider_id?: string; post_process_providers?: PostProcessProvider[]; post_process_api_keys?: SecretMap; post_process_models?: Partial<{ [key in string]: string }>; post_process_prompts?: LLMPrompt[]; post_process_selected_prompt_id?: string | null; mute_while_recording?: boolean; append_trailing_space?: boolean; app_language?: string; experimental_enabled?: boolean; lazy_stream_close?: boolean; keyboard_implementation?: KeyboardImplementation; show_tray_icon?: boolean; paste_delay_ms?: number; typing_tool?: TypingTool; external_script_path: string | null; custom_filler_words?: string[] | null; whisper_accelerator?: WhisperAcceleratorSetting; ort_accelerator?: OrtAcceleratorSetting; whisper_gpu_device?: number; extra_recording_buffer_ms?: number; smart_formatting_enabled?: boolean; smart_formatting_mode?: SmartFormattingMode; smart_formatting_app_aware?: boolean; transcription_languages?: string[]; vocab_candidates?: VocabCandidate[]; hinglish_starter_seeded?: boolean; hinglish_prompt_shown?: boolean; snippets?: Snippet[]; user_first_name?: string; user_last_name?: string; known_names?: string[]; knock_mode_enabled?: boolean; knock_threshold?: number; knock_input_device_id?: string | null; knock_calibration_completed?: boolean; conversation_mode_enabled?: boolean; chat_mode_enabled?: boolean; chat_mode_countdown_secs?: number; conversation_max_utterance_ms?: number }
...
export type HardwareInfo = { platform: string; arch: string; ram_gb: number; is_apple_silicon: boolean; tier: string }
 ...
 */
export type SmartFormattingMode = "raw" | "clean" | "smart" | "email" | "message" | "list"
export type Snippet = { id: string; trigger: string; expansion: string; hits: number; created_at: number }
export type VocabCandidate = { word: string; hits: number; first_seen: number; last_seen: number; promoted: boolean }
